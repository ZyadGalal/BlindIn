...
class MZHangoutSetLocationViewController: UIViewController {
    ...
    @objc func getAllPlaces(){
        ...
        let latitude = coordinates[1] as! Double
            ...
            let customMarker = CircularMarkerShape(frame: CGRect(x: 0, y: 0, width: 50, height: 70), image: currentIndex["image"] as! String, borderColor: UIColor(red: 61/255, green: 101/255, blue: 255/255, alpha: 1.0))
