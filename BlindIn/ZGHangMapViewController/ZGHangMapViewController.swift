...
class ZGHangMapViewController: UIViewController {
    ...
    {
        let customMarker = CustomMarkerShape(frame: CGRect(x: 0, y: 0, width: 50, height: 70), image: "https://blendin-userfiles-mobilehub-1929261559.s3.amazonaws.com/jsaS3/1561364513254", borderColor: UIColor(red: 0/255.0, green: 100/255.0, blue: 255/255.0, alpha: 1.0))
