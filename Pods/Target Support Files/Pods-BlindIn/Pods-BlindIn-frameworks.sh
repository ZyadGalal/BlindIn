...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/M13OrderedDictionary/M13OrderedDictionary.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MOLH/MOLH.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ObjectiveDDP/ObjectiveDDP.framework"
